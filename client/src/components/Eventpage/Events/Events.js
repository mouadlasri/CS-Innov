    ...
    const eventsList = events.map((event) => {
        return (
            <div className="row justify-content-md-center" key={event.id}>
                ...
                <div className="col-xs-12  col-sm-2 col-md-2 col-lg-2 offset-1 event-date text-center">
                    <span className="event-day">{event.date}</span>
                    <span className="event-month">{event.month}</span>
                </div>
                {/* <div className="col-1">
                </div> */}
                <div className="col-xs-12  col-sm-4 col-md-4 col-lg-3 event-details text-left border-left border-right">
                ...
                <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4 event-summary">
